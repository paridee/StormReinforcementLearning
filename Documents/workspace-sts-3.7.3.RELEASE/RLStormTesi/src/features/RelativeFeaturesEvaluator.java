...
public class RelativeFeaturesEvaluator implements FeaturesEvaluator {
	...
	public final static Logger logger	=	LogManager.getLogger(RelativeFeaturesEvaluator.class);
	ActionExecutor	executor;
	public RelativeFeaturesEvaluator(ArrayList<String> opName,int states,int featuresPerState,ActionExecutor executor) {
		super();
		this.opName				=	opName;
		this.states				=	states;
