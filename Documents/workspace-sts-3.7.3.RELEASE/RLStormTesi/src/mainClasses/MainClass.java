...
public class MainClass {
	...
	public static void main(String[] args) {	//arguments (opt): topology name
		...
		LinearGradientDescendSarsaLambda sarsa	=	new LinearGradientDescendSarsaLambda(chooser,(8*STATES_NUM),0.1,0.2,0.01,reader,evaluator,executor,alpha,(2*boltsName.size())+1,(2*boltsName.size()));
		Thread									sarsaTh		=	new Thread(sarsa);
