...
public class MainClass {
	...
	public static void main(String[] args) {	//arguments (opt): topology name
		...
		rm_th.start();
		RewardCalculator					 	rewarder	=	new ParabolicComplexResponseTimeRewarder(800,125,266,2400,ACTIONS_NUM);
		ProcessTimeStateReader					reader		=	new ProcessTimeStateReader(850,0.3,3);
